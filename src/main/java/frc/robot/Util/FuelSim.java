...
public class FuelSim {
    protected static final double PERIOD = .02; //Seconds
    ...
    public static class Fuel {
        ...
        protected Fuel(Translation3d pose, Translation3d vel) {
            this.pos = pos;
            this.vel = vel;
        }
        ...
        protected void update(boolean simulateAirResistance, int subticks) {
            ...
            if (Math.abs(vel.getZ()) < .05 && pos.getZ() <= FUEL_RADIUS + .03) {
    ...
    public class SimIntake {
        ...
        public boolean shouldIntake(Fuel fuel, Pose2d robotPose) {
